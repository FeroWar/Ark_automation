...
class TribeLog(Ark):
    ...
    LOG_REGION = (780, 210, 350, 600)

    _ONLINE_AXIS = (1132, 315, 111, 720)

    _TOGGLE_ONLINE = Button(
        (625, 200), (600, 180, 50, 50), "toggle_online_members.png"
    )
    ...
    def get_tribelog_events(self) -> list[TribeLogMessage]:
    ...
    def get_day_occurrences(self, img: Image.Image) -> list[tuple]:
        ...
        return self.window.locate_all_in_image(
            f"{self.PKG_DIR}/assets/tribelog/tribelog_day.png", img, confidence=0.7, grayscale=True
        )
