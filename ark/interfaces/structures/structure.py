...
class Structure(Ark):
    ...
    TURN_ON = Button((960, 880), (910, 869, 100, 25), "turn_on.png")
    TURN_OFF = Button((960, 880), (910, 869, 100, 25), "turn_off.png")
    ...
    def turn_on(self) -> None:
        ...
        while self.is_turned_off():
            self.click_at(self.TURN_ON.location_x(), self.TURN_ON.location_y(), delay=0.1)
            self.sleep(1)
    ...
    def turn_off(self) -> None:
        ...
        while self.is_turned_on():
            self.click_at(self.TURN_OFF.location_x(), self.TURN_OFF.location_y(), delay=0.1)
            self.sleep(1)
    ...
    def is_turned_on(self) -> bool:
        ...
        return self.inventory.locate_button(
            self.TURN_OFF, grayscale=True, confidence=0.7
        )

    def is_turned_off(self) -> bool:
        """Return whether the Structure can be turned on."""
        return self.inventory.locate_button(
            self.TURN_ON, grayscale=True, confidence=0.7
        )
